...
##
## Debug
ProjectName            :=UnionsAndPreprocessor
...
Objects0=$(IntermediateDirectory)/unions.c$(ObjectSuffix) $(IntermediateDirectory)/unionsChallenge.c$(ObjectSuffix) $(IntermediateDirectory)/preprocessor.c$(ObjectSuffix) $(IntermediateDirectory)/main.c$(ObjectSuffix) $(IntermediateDirectory)/macros.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/preprocessor.c$(ObjectSuffix): preprocessor.c $(IntermediateDirectory)/preprocessor.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/mugiw/Documents/Workspaces/Workspace2/Unions/preprocessor.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/preprocessor.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/preprocessor.c$(DependSuffix): preprocessor.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/preprocessor.c$(ObjectSuffix) -MF$(IntermediateDirectory)/preprocessor.c$(DependSuffix) -MM preprocessor.c

$(IntermediateDirectory)/preprocessor.c$(PreprocessSuffix): preprocessor.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/preprocessor.c$(PreprocessSuffix) preprocessor.c
...
$(IntermediateDirectory)/macros.c$(ObjectSuffix): macros.c $(IntermediateDirectory)/macros.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/mugiw/Documents/Workspaces/Workspace2/Unions/macros.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/macros.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/macros.c$(DependSuffix): macros.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/macros.c$(ObjectSuffix) -MF$(IntermediateDirectory)/macros.c$(DependSuffix) -MM macros.c

$(IntermediateDirectory)/macros.c$(PreprocessSuffix): macros.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/macros.c$(PreprocessSuffix) macros.c
